(function(){
  ...
  .controller("ForgetPassCtrl",['$rootScope','$ionicHistory','$ionicPopup','$state','LoginService',function($rootScope,$ionicHistory, $ionicPopup, $state,LoginService){
    var self = this;
    ...
    self.forgetPass = function(email) {
      LoginService.resetPassword(email).then(function(data){
        var alertPopup = $ionicPopup.alert({
          title: 'Reset Password Success',
          template: 'Your new password has been sent to your email'
        });
        alertPopup.then(function(res) {
          //do something
        });
      ...
      .catch(function(response){
        ...
        var alertPopup = $ionicPopup.alert({
          title: 'Reset Failed',
          template: 'There might be an issue with your internet connection'
        });
        alertPopup.then(function(res) {
          //do something
        });
